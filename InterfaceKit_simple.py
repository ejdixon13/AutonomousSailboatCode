...
### NOTE TO USER ###
# This code is used to see what is attached to the Phidget 
# interface. It would be in your best interest not to understand this file
# unless you have a deep desire to do some digging. Run it to see if temp Sensor is attached
